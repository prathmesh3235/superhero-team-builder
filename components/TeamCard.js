...
const TeamCard = ({ team, type, onSelect, disabledOption }) => (
  <motion.div
  ...
  >
    ...
    >
      ...
      <option value="balanced" disabled={disabledOption === "balanced"}>
        Balanced
      </option>
      <option value="strength" disabled={disabledOption === "strength"}>
        Strength-based
      </option>
      <option value="intelligence" disabled={disabledOption === "intelligence"}>
        Intelligence-based
      </option>
      <option value="random" disabled={disabledOption === "random"}>
        Random
      </option>
    </select>
    {team.map((hero, index) => (
      ...
      >
        ...
        <span className="text-white text-sm sm:text-base truncate flex-grow">
          {hero.name}
        </span>
