  ...
  >
    ...
    <div className="grid grid-cols-2 gap-4">
      <div>
        ...
        <StatBar icon={<Shield />} label="Strength" value={statsA.totalStrength} />
        <StatBar icon={<Brain />} label="Intelligence" value={statsA.totalIntelligence} />
        <StatBar icon={<Zap />} label="Speed" value={statsA.totalSpeed} />
      </div>
      <div>
        <h4 className="text-lg font-semibold text-white mb-2">Team B Stats</h4>
        <StatBar icon={<Shield />} label="Strength" value={statsB.totalStrength} />
        <StatBar icon={<Brain />} label="Intelligence" value={statsB.totalIntelligence} />
    ...
    <ResponsiveContainer width="100%" height={200} className="mt-4">
      <BarChart data={[
        {name: 'Strength', TeamA: statsA.totalStrength, TeamB: statsB.totalStrength},
        {name: 'Intelligence', TeamA: statsA.totalIntelligence, TeamB: statsB.totalIntelligence},
